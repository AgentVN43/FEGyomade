    ...
    return (
        <section>
            ...
            <div className="container-fluid">
                <div className="cs_shop_filter">
                    <div className="cs_filter_overlay" />
                    <button className="cs_filter_close">X</button>
